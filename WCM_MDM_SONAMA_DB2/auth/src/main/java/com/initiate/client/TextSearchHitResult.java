    ...
    extends SearchResult
{
    ...
    protected TextSearchHitResult.StoredValues storedValues;
     ...
     * @return
     *     possible object is
     *     {@link TextSearchHitResult.StoredValues }
     *     
     */
    public TextSearchHitResult.StoredValues getStoredValues() {
        return storedValues;
    }
     ...
     *     
     */
    public void setStoredValues(TextSearchHitResult.StoredValues value) {
    ...
    public static class StoredValues {
        ...
        protected List<TextSearchHitResult.StoredValues.Entry> entry;
         ...
         * {@link TextSearchHitResult.StoredValues.Entry }
         * 
         * 
         */
        public List<TextSearchHitResult.StoredValues.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<TextSearchHitResult.StoredValues.Entry>();
            }
            return this.entry;
        }
