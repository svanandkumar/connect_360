...
/**
 * <p>Java class for getIdEntityListByIdEntityIds complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="getIdEntityListByIdEntityIds">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="id" type="{http://client.esoa.mdm.ibm.com/}idEntityId" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "getIdEntityListByIdEntityIds", propOrder = {
    "id",
    "cvwName",
    "source",
    "attribute"
})
public class GetIdEntityListByIdEntityIds {

    protected List<IdEntityId> id;
     ...
     * 
     */
    public List<IdEntityId> getId() {
        if (id == null) {
            id = new ArrayList<IdEntityId>();
        }
        return this.id;
    }
