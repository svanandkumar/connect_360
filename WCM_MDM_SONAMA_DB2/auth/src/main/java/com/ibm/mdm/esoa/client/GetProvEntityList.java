...
/**
 * <p>Java class for getProvEntityList complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="getProvEntityList">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="id" type="{http://client.esoa.mdm.ibm.com/}providerId" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "getProvEntityList", propOrder = {
    "id",
    "cvwName",
    "source",
    "attribute"
})
public class GetProvEntityList {

    protected List<ProviderId> id;
     ...
     * 
     */
    public List<ProviderId> getId() {
        if (id == null) {
            id = new ArrayList<ProviderId>();
        }
        return this.id;
    }
